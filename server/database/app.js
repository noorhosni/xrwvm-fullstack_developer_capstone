...
// Express route to fetch reviews by a particular state
app.get('/fetchReviews/:state', async (req, res) => {
  try {
...
// Express route to fetch reviews by a particular car_make
...
// Express route to fetch reviews by a particular car_make and car_model
